...
class WeightGoalVC: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        progressSize.constant = (14.28 * 6 / 100) * self.view.width
        ...
        let navTitle = NSMutableAttributedString(string: Messages.txtStep6, attributes:[
        ...
        self.pickerView.selectRow(40, inComponent: 0, animated: true)
    }
}
//MARK:-Button Actions
extension WeightGoalVC {
    ...
    @IBAction func actionNext(_ sender: UIButton) {
        let aboutVC = StoryBoard.Main.instantiateViewController(withIdentifier: "EquipmentVC") as! EquipmentVC
        param["weight_goal"] = 20 + pickerView.selectedRow(inComponent: 0)
        aboutVC.param = param
...
extension WeightGoalVC: UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        if component == 0 {
            return NSAttributedString(string: "\(20 + row)", attributes: [NSAttributedString.Key.foregroundColor: UIColor.white])
        } else {
...
extension WeightGoalVC: UIPickerViewDelegate {
